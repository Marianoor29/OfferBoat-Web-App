                ...
                <div className="flex mt-10 gap-6">
                  <div className="w-full lg:w-[90%] md:w-[90%] border-b border-gray-200 pb-5">
                    ...
                    <BoatDetail
                      Length={
                        listingDetails.type === "TripRequest" ?
                          listingDetails.listingId?.lengthRange :
                          listingDetails.type !== "TripRequest" ?
                            listingDetails?.lengthRange :
                            'Not Mention'}
                      Model={
                        listingDetails.type === "TripRequest" ?
                          listingDetails.listingId?.boatManufacturer :
                          listingDetails.type !== "TripRequest" ?
                            listingDetails?.boatManufacturer :
                            "Not Mention"}
                      Category={
                        listingDetails.type === "TripRequest" ?
                          listingDetails.listingId?.boatCategory :
                          listingDetails.type !== "TripRequest" ?
                            listingDetails?.boatManufacturer :
                            "Not Mention"}
                    />
